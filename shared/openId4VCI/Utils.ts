...
export const ErrorLogMessages: Record<VCIServerErrorCode, string> = {
  ...
  [VCIServerErrorCode.INVALID_TOKEN]: 'Access token is invalid or expired.',
  ...
  [VCIServerErrorCode.USER_CANCELLED]: 'User cancelled the operation.',

  [VCIServerErrorCode.NETWORK_ERROR]:
    'Network request failed while communicating with issuer.',

  [VCIServerErrorCode.TIMEOUT_ERROR]: 'Network request timed out.',

  [VCIServerErrorCode.PARSING_ERROR]: 'Failed to parse response from issuer.',

  [VCIServerErrorCode.VERIFICATION_FAILED]: 'Credential verification failed.',

  [VCIServerErrorCode.STORAGE_ERROR]: 'Failed to store credential or metadata.',
